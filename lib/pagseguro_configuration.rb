class PagseguroConfiguration < Configuration
  ...
  preference :sandbox_billing_url, :string, :default => "http://localhost:3000/pagseguro_mockup/webpagto"
  preference :sandbox_verification_url, :string, :default => "http://localhost:3000/pagseguro_mockup/default"
